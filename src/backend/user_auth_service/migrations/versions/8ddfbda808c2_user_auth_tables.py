...
Revision ID: 8ddfbda808c2
Revises: 
Create Date: 2024-12-12 13:35:53.902359
...
def upgrade() -> None:
    ...
    sa.Column('organization_role', sa.Enum('NotVerifyed', 'Verifyed', name='organizationroleenum'), nullable=False),
    sa.Column('created', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated', sa.DateTime(timezone=True), nullable=True),
    sa.PrimaryKeyConstraint('id'),
