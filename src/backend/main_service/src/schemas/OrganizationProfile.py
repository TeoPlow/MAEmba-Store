...
class OrganizationProfile:
    ...
    @property
    def contact_numbers(self) -> str:
        return self.__contact_numbers

    @contact_numbers.setter
    def contact_numbers(self, value: str):
        if not isinstance(value, str):
            raise ValueError('contact_numbers должен быть str')
        for number in value:
    ...
    def validate_data(cls, data: Dict[str, Any]) -> "OrganizationProfile":
        """
